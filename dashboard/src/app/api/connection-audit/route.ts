...
const STAGE_AUDIT_CONFIG: StageAuditConfig[] = [
  ...
  { stage: 10, label: 'Pitch Drafting', stageKey: 'S10_PITCH_DRAFTING', brainManifestKey: 'S10_PITCH_DRAFTING', uiRoutes: ['/pitches', '/pitch'], apiRoutes: ['/api/campaigns/[id]/scripts'], outputFiles: ['08-pitch-draft.md', '10-pitch-draft.md', '10-pitch-draft.json'] },
