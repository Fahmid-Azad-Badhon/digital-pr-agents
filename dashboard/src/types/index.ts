...
export const MODEL_ROUTES: ModelRoute[] = [
  { stageNumber: 1, stageName: 'Campaign Intake', tier: 4, tierName: 'Orchestration', primaryModel: 'Hy3 Preview', qualityGateModel: 'GPT-5.5 (optional)', fallbackModel: 'MiniMax M2.5', purpose: 'Campaign setup and brief structuring', costLevel: 'low', speedLevel: 'fast', qualityLevel: 'good', isMandatory: false, status: 'idle' },
  { stageNumber: 2, stageName: 'Data Extraction', tier: 2, tierName: 'Research', primaryModel: 'Nemotron 3 Super', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'MiniMax M2.5', purpose: 'Long-context study extraction and analysis', costLevel: 'low', speedLevel: 'medium', qualityLevel: 'excellent', isMandatory: true, status: 'idle' },
  { stageNumber: 3, stageName: 'Research Enrichment', tier: 2, tierName: 'Research', primaryModel: 'Nemotron 3 Super', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'MiniMax M2.5', purpose: 'SERP research and source verification', costLevel: 'low', speedLevel: 'medium', qualityLevel: 'excellent', isMandatory: true, status: 'idle' },
  { stageNumber: 4, stageName: 'Data & Research Analysis', tier: 2, tierName: 'Research', primaryModel: 'Nemotron 3 Super', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'MiniMax M2.5', purpose: 'Cross-validate statistics, analyze keywords, score source credibility, produce campaign insights', costLevel: 'low', speedLevel: 'medium', qualityLevel: 'excellent', isMandatory: true, status: 'idle' },
  { stageNumber: 5, stageName: 'Angle Generation', tier: 4, tierName: 'Orchestration', primaryModel: 'Hy3 Preview', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'MiniMax M2.5', purpose: 'Generate 40 pitch angles across 20 categories', costLevel: 'low', speedLevel: 'fast', qualityLevel: 'good', isMandatory: true, status: 'idle' },
  { stageNumber: 6, stageName: 'Beat Matching', tier: 4, tierName: 'Orchestration', primaryModel: 'Hy3 Preview', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'MiniMax M2.5', purpose: 'Map angles to journalist beats', costLevel: 'low', speedLevel: 'fast', qualityLevel: 'good', isMandatory: false, status: 'idle' },
  { stageNumber: 7, stageName: 'Pitch Selection', tier: 4, tierName: 'Orchestration', primaryModel: 'Hy3 Preview', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'MiniMax M2.5', purpose: 'Human review + Orchestrator selection of best angles', costLevel: 'low', speedLevel: 'fast', qualityLevel: 'good', isMandatory: true, status: 'idle' },
  { stageNumber: 8, stageName: 'Journalist Collection', tier: 4, tierName: 'Orchestration', primaryModel: 'Hy3 Preview', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'MiniMax M2.5', purpose: 'Collect 800 journalists per beat via Muck Rack/SERP', costLevel: 'low', speedLevel: 'medium', qualityLevel: 'good', isMandatory: false, status: 'idle' },
  { stageNumber: 9, stageName: 'Journalist Intelligence', tier: 2, tierName: 'Research', primaryModel: 'Nemotron 3 Super', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'MiniMax M2.5', purpose: 'Analyze journalist profiles and coverage history', costLevel: 'low', speedLevel: 'medium', qualityLevel: 'excellent', isMandatory: true, status: 'idle' },
  { stageNumber: 10, stageName: 'Pitch Drafting', tier: 3, tierName: 'Production', primaryModel: 'MiniMax M2.5', qualityGateModel: 'gpt-oss-120B → GPT-5.5', fallbackModel: 'Hy3 Preview', purpose: 'Generate 6 pitch variants (straight, punchy, data-heavy, personalized, narrative, localized)', costLevel: 'low', speedLevel: 'fast', qualityLevel: 'good', isMandatory: true, status: 'idle' },
  { stageNumber: 11, stageName: 'Email Optimization', tier: 1, tierName: 'Quality Gate', primaryModel: 'GPT-5.5 Thinking', qualityGateModel: 'MiniMax M2.5 (polish)', fallbackModel: 'Nemotron 3 Super', purpose: 'Final email optimization with 16-factor scorecard, min 8.5/10', costLevel: 'high', speedLevel: 'slow', qualityLevel: 'excellent', isMandatory: true, status: 'idle' },
  { stageNumber: 12, stageName: 'Final Package', tier: 3, tierName: 'Production', primaryModel: 'MiniMax M2.5', qualityGateModel: 'GPT-5.5 Thinking', fallbackModel: 'Hy3 Preview', purpose: 'Compile final export-ready package', costLevel: 'low', speedLevel: 'fast', qualityLevel: 'good', isMandatory: false, status: 'idle' },
  { stageNumber: 13, stageName: 'Google Doc Export', tier: 6, tierName: 'Technical', primaryModel: 'Qwen3 Coder', qualityGateModel: 'GLM-4.5-Air', fallbackModel: 'Poolside Laguna', purpose: 'Export to Google Doc format', costLevel: 'low', speedLevel: 'fast', qualityLevel: 'basic', isMandatory: false, status: 'idle' },
  { stageNumber: 14, stageName: 'Technical Validation', tier: 6, tierName: 'Technical', primaryModel: 'Qwen3 Coder', qualityGateModel: 'GLM-4.5-Air', fallbackModel: 'Poolside Laguna', purpose: 'JSON, Python, PowerShell, ASCII checks', costLevel: 'low', speedLevel: 'fast', qualityLevel: 'basic', isMandatory: false, status: 'idle' },
  { stageNumber: 15, stageName: 'Browser Validation', tier: 4, tierName: 'Orchestration', primaryModel: 'Hy3 + GPT-5.5', qualityGateModel: 'Nemotron 3 Super', fallbackModel: 'MiniMax M2.5', purpose: 'Chrome debug, SERP, Boolean search availability', costLevel: 'medium', speedLevel: 'medium', qualityLevel: 'good', isMandatory: false, status: 'idle' },
  { stageNumber: 16, stageName: 'Regression & Production', tier: 1, tierName: 'Quality Gate', primaryModel: 'GPT-5.5 Thinking', qualityGateModel: 'gpt-oss-120B', fallbackModel: 'Nemotron 3 Super', purpose: 'Stage validation, pitch quality, export readiness', costLevel: 'high', speedLevel: 'slow', qualityLevel: 'excellent', isMandatory: true, status: 'idle' },
];
