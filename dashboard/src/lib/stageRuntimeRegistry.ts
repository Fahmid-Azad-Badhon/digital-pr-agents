...
export const STAGE_RUNTIME_BINDINGS: StageRuntimeBinding[] = [
  ...
  { stage: 10, stageKey: 'S10_PITCH_DRAFTING', brainManifestKey: 'S10_PITCH_DRAFTING', runtimeKind: 'script_runner', executable: true, executionTarget: 'scripts/draft-pitch-draft.cmd', outputFiles: ['08-pitch-draft.md', '10-pitch-draft.md'] },
